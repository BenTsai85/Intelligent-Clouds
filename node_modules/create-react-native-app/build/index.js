      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            _context.next = 10;
            return _fsPromise2.default.mkdir(root);
          ...
          case 17:
            ...
            _context.next = 22;
            return _fsPromise2.default.writeFile(_path2.default.join(root, 'package.json'), (0, _stringify2.default)(packageJson, null, 2));
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.t0 = JSON;
            _context4.next = 4;
            return _fsPromise2.default.readFile(packageJsonPath);
          ...
          case 8:
            ...
            if (!_semver2.default.satisfies(process.version, packageJson.engines.node)) {
              console.error(_chalk2.default.red('You are currently running Node %s but create-react-native-app requires %s.' + ' Please use a supported version of Node.\n'), process.version, packageJson.engines.node);
              process.exit(1);
            }
...
function getInstallPackage(version) {
  var packageToInstall = 'react-native-scripts';
...
function checkAppName(appName, packageName) {
  var allDependencies = ['react-native-scripts', 'exponent', 'expo', 'vector-icons', 'react', 'react-native'];
